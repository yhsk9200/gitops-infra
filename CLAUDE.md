...
0. **tailnet 편입** (수동): OCI 노드 + NAS 편입 (Mac은 기편입). 검증 = 3자 상호 `tailscale ping`. kubeconfig 방식 C 전환 동반 — **절차·함정은 `docs/tailnet-minio-runbook.md`** (OCI INPUT REJECT, k3s tls-san)
